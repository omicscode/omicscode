...
Since 2024- I use only RUST from bioinformatics, software, cloud and hpc management, web and machine and deep learning. Use of specific one to two selected languages for everything has enabled me to scale my abilities to everything at every employment and i served as a single lead bioinformatician from software developer to bioinformatics data analysis, machine learning and HPC cloud management. 
