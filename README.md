...
[![CodeBioGenomics](https://skillicons.dev/icons?i=js,html,css, bash, rust, discord, linux, materialui, obsidian, r, py, pytorch,tensorflow,tauri,react,ts,vscode,remix)]
